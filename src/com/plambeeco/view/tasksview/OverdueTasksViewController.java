...
public class OverdueTasksViewController {
    @FXML
    ...
    public OverdueTasksViewController(BorderPane rootScene) {
        this.rootScene = rootScene;
    }

    @FXML
    private void initialize(){
        tvTasks.setItems(FXCollections.observableList(TaskModelProcessor.getAllOverdueTasks()));
