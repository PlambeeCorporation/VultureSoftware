...
import com.plambeeco.view.loginviews.IControlledScreen;
...
{
    // Hashmap which holds the name of a screen and the node for the screen
            ...
            {    
                ...
                Timeline fade = new Timeline(
                    ...
                    public void handle(ActionEvent t) 
                    {
                        ...
                        getChildren().remove(0); // remove the displayed screen
                        getChildren().add(0, screens.get(name)); // add the screen
                        VultureApplication.resizeScreen();	//Size the stage to the current screen
